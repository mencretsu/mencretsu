...
# ─── Chapter 2 — THE GRIND (candlestick + radial clock bawah) ────────────────
#
# Tiap "candle" = satu minggu commit.
#   body  = range dari hari terendah ke hari tertinggi minggu itu
#   wick  = min/max absolute minggu itu (sama karena daily data)
#   warna = hijau kalau minggu ini > minggu lalu, merah kalau turun
# Radial clock dipindah ke bawah chart, dikasih ruang napas.
...
if __name__ == "__main__":
    ...
    os.makedirs("assets_preview", exist_ok=True)

    with open("assets_preview/chapter1.svg", "w") as f:
        f.write(ch1(data))
    print("→ assets_preview/chapter1.svg")

    with open("assets_preview/chapter2.svg", "w") as f:
        f.write(ch2(data))
    print("→ assets_preview/chapter2.svg")
